...
const router = express.Router() // aqui estou criando a primeira parte da rota
...
//PATCH
 async function corrigeMulher(request, response) {
    try {
        const mulherEncontrada = mulheres.findById(request.params.id)
        ...
        if (request.body.citacao) {
            mulherEncontrada.citacao = request.body.imagem
        }
...
app.use(router.patch('/mulheres/:id', corrigeMulher)) // configurei rota PATCH /muheres
